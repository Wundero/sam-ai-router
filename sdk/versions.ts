...
export function v2CallOptionsToV4(options: LanguageModelV2CallOptions): LanguageModelV4CallOptions {
    return {
        ...options,
...
export function v3CallOptionsToV4(options: LanguageModelV3CallOptions): LanguageModelV4CallOptions {
    return {
        ...options,
